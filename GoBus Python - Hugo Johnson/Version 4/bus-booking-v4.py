# Johnson, Hugo - Massey Overnighter Service (V4)
    ...
    def create_booking(self):
        ...
        try:
            ...
            if preview_booking['seats_akl'] > 15:
                ...
                has_error='yes'
            elif preview_booking['seats_akl'] <= 0:
                self.seats_auckland_label.config(text="Enter positive number", fg='red')
                self.seats_auckland_entry.config(bg=error)
                has_error='yes'
            else: 
        ...
        try:
            ...
            if preview_booking['seats_pn'] > 15:
                ...
                has_error='yes'
            elif preview_booking['seats_pn'] <= 0:
                self.seats_palmerston_north_label.config(text="Enter positive number", fg='red')
                self.seats_palmerston_north_entry.config(bg=error)
                has_error='yes'
            else: 
        ...
        try:
            ...
            if preview_booking['bunks_akl'] > 15:
                ...
                has_error='yes'
            elif preview_booking['bunks_akl'] <= 0:
                self.bunks_auckland_label.config(text="Enter positive number", fg='red')
                self.bunks_auckland_entry.config(bg=error)
                has_error='yes'
            else: 
        ...
        try:
            ...
            if preview_booking['bunks_pn'] > 15:
                ...
                has_error='yes'
            elif preview_booking['bunks_pn'] <= 0:
                self.bunks_palmerston_north_label.config(text="Enter positive number", fg='red')
                self.bunks_palmerston_north_entry.config(bg=error)
                has_error='yes'
            else: 
...
class Preview:
    def __init__(self, partner, preview_booking):
        ...
        self.seats_akl_preview_value = Label(self.preview_frame, font='Arial 14 bold', fg=font_color, text=f"{preview_booking['seats_akl']} seat(s) (${(preview_booking['seats_akl'])*25})", bg=background_color)
        ...
        self.seats_pn_preview_value = Label(self.preview_frame, font='Arial 14 bold', fg=font_color, text=f"{preview_booking['seats_pn']} seat(s) (${(preview_booking['seats_pn'])*25})", bg=background_color)
        ...
        self.bunks_akl_preview_value = Label(self.preview_frame, font='Arial 14 bold', fg=font_color, text=f"{preview_booking['bunks_akl']} bunks(s) (${(preview_booking['bunks_akl'])*50})", bg=background_color)
        ...
        self.bunks_pn_preview_value = Label(self.preview_frame, font='Arial 14 bold', fg=font_color, text=f"{preview_booking['bunks_pn']} seat(s) (${(preview_booking['bunks_pn'])*50})", bg=background_color)
        ...
        self.total_value = Label(self.preview_frame, font='Arial 14 bold', fg=font_color, bg=background_color, text=f"${int(preview_booking['seats_akl']*25)+int(preview_booking['seats_pn']*25)+int(preview_booking['bunks_akl']*50)+int(preview_booking['bunks_pn']*50)}")
        self.total_value.grid(row=8, column=1, pady=10, padx=10)

        # Confirm booking button (row 9)
        self.confirm_button = Button(self.preview_frame, width=150, font='Arial 14 bold',text='Confirm', bg='green', fg=font_color, command=lambda: self.confirm_preview(preview_booking, partner))
        self.confirm_button.grid(row=9, column = 0, pady=30, padx=5)
        ...
        self.cancel_button.grid(row=9, column = 1, pady=30, padx=5)

    def confirm_preview(self, preview_booking, partner):
        booking_statement = f"Name: {preview_booking['name']}, Phone number: {preview_booking['phone']}, Seat(s) to Aucklnd: {preview_booking['seats_akl']}, Seat(s) to Palmerston North: {preview_booking['seats_pn']}, Bunk(s) in Auckland: {preview_booking['bunks_akl']}, Bunk(s) in Palmerston North: {preview_booking['bunks_pn']}"
        booking_history.append(booking_statement)
        partner.name_entry.delete(0,'end')
        partner.phone_entry.delete(0,'end')
        partner.seats_palmerston_north_entry.delete(0,'end')
        partner.seats_auckland_entry.delete(0,'end')
        partner.bunks_palmerston_north_entry.delete(0,'end')
        partner.bunks_auckland_entry.delete(0,'end')
